...
const TransRecent = () => {
  const transactions = [
    ...
    { id: 8, amount: 700, account: 'A129', method: 'Credit Card', type: 'Deposit', date: '2023-01-07', status: 'Completed' },
    { id: 9, amount: 700, account: 'A129', method: 'Credit Card', type: 'Deposit', date: '2023-01-07', status: 'Completed' },
    { id: 10, amount: 700, account: 'A129', method: 'Credit Card', type: 'Deposit', date: '2023-01-07', status: 'Completed' },
    { id: 11, amount: 700, account: 'A129', method: 'Credit Card', type: 'Deposit', date: '2023-01-07', status: 'Completed' },
    { id: 12, amount: 700, account: 'A129', method: 'Credit Card', type: 'Deposit', date: '2023-01-07', status: 'Completed' },
    { id: 13, amount: 700, account: 'A129', method: 'Credit Card', type: 'Deposit', date: '2023-01-07', status: 'Completed' },
  ...
  return (
    <div className=' my-8 overflow-x-auto overflow-y-hidden'>

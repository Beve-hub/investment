...
const DiamondModal = ({onClose,showDiamond}:DiamondModalProps) => {
    const [formInput, setFormInput] = useState({
        amount: '',
        cryptoWallet: '',
        cryptoChannel: '',
        walletAddress: '',
        packagePlan: 'Diamond Plan',
        method: 'Deposit'
    });
    ...
    return (
        <div className={`fixed inset-0 flex justify-center z-20 items-center ${showDiamond ? "visible bg-black/60" : "invisible"}`} onClick={onClose}>
        {showDiamond && (
            ...
            <div className='grid py-[3rem] px-6 items-center justify-between gap-6 '>
                <div>
                    <p className="font-display text-[--bg-color] font-bold text-2xl">Diamond Plan</p>
                </div>
                <form onSubmit={handleSubmit} className='grid gap-4'>
                            <div className="relative">
                                ...
                                />
                                <p className='text-xs'>You can invest from $5001 to $10000</p>
                            </div>
                            {accountSelect && (
                                <>
                                    <div>

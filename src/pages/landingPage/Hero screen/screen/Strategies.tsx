        ...
        <section id="strategies" className="relative min-h-[20rem] mt-20  py-10 w-screen grid justify-center overflow-hidden">
            ...
            <div className="mx-auto gap-6 grid md:grid-cols-3 items-baseline justify-center">
              ...
              <div className='w-[20rem] grid gap-4'>
                  ...
                  <p className="text-lg text-balance font-display"><span className="font-semibold">A conservative philosophy with a focus on valuation and diversification.</span>Our investment team builds, maintains and improves our models over time through diligent fundamental research.</p>
                  <div className='flex items-center '>
                      <p className='font-semibold font-display'>Read More</p>
              ...
              <div className='w-[20rem] grid gap-4'>
                  ...
                  <p className="text-lg text-balance font-display"><span className="font-semibold">Tactically balanced total return, income generation, and capital preservation.</span> Our firm’s conservative investment approach and a focus on maintaining liquidity at the individual account level establishes minimum quality parameters.</p>
                  <div className='flex items-center '>
                      <p className='font-semibold font-display'>Read More</p>
                      <img src={arrow} alt="" className="w-[1.2rem] mt-[4px]"/>
                  </div>    
